document.addEventListener("DOMContentLoaded", () => {
  ...
  document.getElementById("checkoutButton").addEventListener("click", () => {
    ...
    summary.innerHTML = `Du <b>${startDate.toLocaleDateString("fr-FR")}</b> au <b>${endDate.toLocaleDateString("fr-FR")}</b><br><b>${adults}</b> adulte(s), <b>${children}</b> enfant(s)<br>Total estimé : <b>${total.toFixed(2)} €</b>`;
